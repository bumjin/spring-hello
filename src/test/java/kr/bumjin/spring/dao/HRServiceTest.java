...
import kr.bumjin.spring.service.HRService;
...
public class HRServiceTest extends AbstractDependencyInjectionSpringContextTests {
	...
	public void setHRService(HRService hrServie) {
		this.hrService = hrServie;
	}
